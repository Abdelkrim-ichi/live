;(function (w, d) {
  ...
  function initWidget(root) {
    ...
    function requestData(cfg) {
      ...
      payload.append('tab', 'widget_matches')
      payload.append('league_id', cfg.league_id)
      if (cfg.season) payload.append('season', cfg.season)
      payload.append('limit', cfg.limit || 10)
