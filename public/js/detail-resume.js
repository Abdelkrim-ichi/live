(function (w, d) {
  ...
  document.addEventListener('DOMContentLoaded', function(){
    ...
    nodes.forEach(function(root){
      ...
      C.on(inst, 'stats',   function(e){ renderTopStats(inst, e.detail || []); });
      C.on(inst, 'events',  function(e){ renderEvents(inst, e.detail || []); renderEventsMini(inst, e.detail || []); renderSubsMini(inst, e.detail || []); });
